...
//	}
	...
	public FindLeadsChildWindowPage switchtoChildWindow() {
		...
		getDriver().switchTo().window(lst.get(1));
		return this;
	}

	public FindLeadsChildWindowPage enterFirstLookupFirstName() {
		getDriver().findElement(By.xpath("//input[@name='firstName']")).sendKeys("Cathy");
		return this;
	}
	...
	public MergeLeadPage clickFirstResulID() {
		getDriver().findElement(By.xpath("//a[@class='linktext']")).click();
		return new MergeLeadPage();
	}

	public FindLeadsChildWindowPage enterSecondLookupFirstName() {
		getDriver().findElement(By.xpath("//input[@name='firstName']")).sendKeys("SS");
		return this;
	}
